...
abstract class LoadableRouters extends Routers implements ILoadableRoute
{
    /**
     * @var string
     */
    ...
    public function findUrl(?string $method = null, $parameters = null, ?string $name = null): string
    {
        ...
        if ($group !== null && count($group->getDomains()) !== 0 && Route::request()->getHost() !== $group->getDomains()[0]) {
